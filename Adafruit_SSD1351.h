...
typedef struct Adafruit_SSD1351{ //  : public virtual Adafruit_GFX {
// public:
...
/*  void spiwrite(uint8_t);
  ...
  void rawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color);*/
	...
	static const int16_t WIDTH, HEIGHT;   // This is the 'raw' display w/h - never changes
